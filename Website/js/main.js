...
var chart = c3.generate({
    ...
    data: {
      columns: [
        ['192.168.0.0', 30, 20, 50, 40, 50, 25, 50, 24, 10, 40, 15, 25, 5, 60, 12, 43, 12, 4, 5],
        ['178.16.0.0', 50, 24, 100, 40, 15, 25, 10, 20, 100, 30, 10, 15, 25, 50, 10, 10, 40, 15, 25, 20, 10],
        ['179.16.0.0', 50, 10, 100, 40, 15, 25, 50, 100, 10, 40, 15, 25, 20, 100, 30, 100, 15, 50, 20, 100, 40, 50],
        ['255.67.8.12', 10, 20, 10, 30, 10, 15, 50, 20, 10, 4, 50, 5, 20, 10, 4, 150, 50, 6, 12, 43, 12, 4, 5],
        ['8.8.8.8', 50, 20, 10, 40, 30, 50, 60, 12, 43, 12, 40, 5, 50, 6, 12, 43, 12, 4, 5]
      ]
    },
    axis: {
      x: {
